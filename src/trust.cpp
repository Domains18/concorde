...
void TrustStore::save()
{
    ...
    {
        file << pubkey << "|" << info.device_name << "|" << info.fingerprint << "|"
...
{
    {
        ...
        PeerInfo info{pubkey_hex, device_name, fingerprint, now, now};
...
PairingManager::PairingManager(TrustStore& trust_store) : trust_store_(trust_store) {}

bool PairingManager::request_approval(const std::string& device_name, const std::string& pubkey_hex,
                                      const std::string& fingerprint)
{
    std::cout << "\n╔════════════════════════════════════════╗\n";
